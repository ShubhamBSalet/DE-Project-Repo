...
<body>
    ...
    <div class="container mt-5">
     ...
     background: linear-gradient(135deg, #3a8e69, #94e6a7); color:white; scroll-behavior:smooth;">
    ...
    <div class='d-flex justify-content-end mb-2'>
        <div class='bg-success text-white px-3 py-2 rounded-3 shadow-sm' style='max-width:70%;'>
            $msg
        </div>
    </div>";
                } else {
